...
def statistical_analysis(var1, var2, var3, var4, var5, var6, var7, var8, var9, var10, var11, var12, param):
    ...
    sd_discrepancy_prov1 = round(sampleStandardDeviation([var1, var4, var7, var10]),3) #standard deviation forecast discrepancy for each provider
    sd_discrepancy_prov2 = round(sampleStandardDeviation([var2, var5, var8, var11]),3) #if there are at least two values available
    sd_discrepancy_prov4 = round(sampleStandardDeviation([var3, var6, var9, var12]),3)
    ...
    dictionary = { #save the values to dictionary to make them accessible for the HTML template
        ...
        'most_accurate_forecast_'+str(param) : most_accurate_forecast,
    }
